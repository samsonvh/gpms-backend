...
namespace GPMS.Backend.Data.Migrations
{
    ...
    [Migration("20240721164430_Change semi finished product id int step IO into nullable")]
    partial class ChangesemifinishedproductidintstepIOintonullable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.ProductionPlans.ProductionPlan", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 21, 16, 44, 28, 22, DateTimeKind.Utc).AddTicks(7243));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Products.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 21, 16, 44, 28, 3, DateTimeKind.Utc).AddTicks(2586));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Requests.InspectionRequest", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 21, 16, 44, 27, 993, DateTimeKind.Utc).AddTicks(9340));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Requests.WarehouseRequest", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 21, 16, 44, 28, 42, DateTimeKind.Utc).AddTicks(5719));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Results.FaultyProduct", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 21, 16, 44, 27, 993, DateTimeKind.Utc).AddTicks(878));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Results.InspectionRequestResult", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 21, 16, 44, 28, 1, DateTimeKind.Utc).AddTicks(930));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Results.ProductionProcessStepResult", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 21, 16, 44, 28, 34, DateTimeKind.Utc).AddTicks(2012));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Staffs.Account", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 21, 16, 44, 27, 991, DateTimeKind.Utc).AddTicks(5017));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Warehouses.WarehouseTicket", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 21, 16, 44, 28, 50, DateTimeKind.Utc).AddTicks(2757));
