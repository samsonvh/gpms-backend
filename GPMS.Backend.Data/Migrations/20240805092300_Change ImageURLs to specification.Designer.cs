...
namespace GPMS.Backend.Data.Migrations
{
    ...
    [Migration("20240805092300_Change ImageURLs to specification")]
    partial class ChangeImageURLstospecification
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.ProductionPlans.ProductionPlan", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 5, 9, 22, 58, 548, DateTimeKind.Utc).AddTicks(6028));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Products.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 5, 9, 22, 58, 541, DateTimeKind.Utc).AddTicks(9387));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Requests.InspectionRequest", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 5, 9, 22, 58, 535, DateTimeKind.Utc).AddTicks(839));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Requests.WarehouseRequest", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 5, 9, 22, 58, 562, DateTimeKind.Utc).AddTicks(3947));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Results.FaultyProduct", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 5, 9, 22, 58, 534, DateTimeKind.Utc).AddTicks(3754));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Results.InspectionRequestResult", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 5, 9, 22, 58, 540, DateTimeKind.Utc).AddTicks(3086));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Results.ProductionProcessStepResult", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 5, 9, 22, 58, 557, DateTimeKind.Utc).AddTicks(3250));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Staffs.Account", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 5, 9, 22, 58, 533, DateTimeKind.Utc).AddTicks(146));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Warehouses.WarehouseTicket", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 5, 9, 22, 58, 567, DateTimeKind.Utc).AddTicks(6220));
