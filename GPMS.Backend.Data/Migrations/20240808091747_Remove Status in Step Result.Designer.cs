...
namespace GPMS.Backend.Data.Migrations
{
    ...
    [Migration("20240808091747_Remove Status in Step Result")]
    partial class RemoveStatusinStepResult
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.ProductionPlans.ProductionPlan", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 8, 9, 17, 45, 220, DateTimeKind.Utc).AddTicks(6663));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Products.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 8, 9, 17, 45, 214, DateTimeKind.Utc).AddTicks(2967));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Requests.InspectionRequest", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 8, 9, 17, 45, 207, DateTimeKind.Utc).AddTicks(7709));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Requests.WarehouseRequest", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 8, 9, 17, 45, 233, DateTimeKind.Utc).AddTicks(7795));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Results.FaultyProduct", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 8, 9, 17, 45, 207, DateTimeKind.Utc).AddTicks(1573));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Results.InspectionRequestResult", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 8, 9, 17, 45, 212, DateTimeKind.Utc).AddTicks(7646));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Results.ProductionProcessStepResult", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 8, 9, 17, 45, 229, DateTimeKind.Utc).AddTicks(972));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Staffs.Account", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 8, 9, 17, 45, 205, DateTimeKind.Utc).AddTicks(8147));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Warehouses.WarehouseTicket", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 8, 9, 17, 45, 248, DateTimeKind.Utc).AddTicks(6905));
