...
namespace GPMS.Backend.Services.Utils.Validators
{
    public class MaterialInputDTOValidator : AbstractValidator<MaterialInputDTO>
    {
        public MaterialInputDTOValidator()
        {
            ...
            RuleFor(inputDTO => inputDTO.Name).Matches(@"^[a-zA-Z0-9À-ỹ\s]+$").When(inputDTO => inputDTO.IsNew).WithMessage("Name can not contains special character");
            ...
            RuleFor(inputDTO => inputDTO.ConsumptionUnit).Matches(@"^[a-zA-Z0-9À-ỹ\s]+$").When(inputDTO => inputDTO.IsNew).WithMessage("ConsumptionUnit can not contains special character");
            ...
            RuleFor(inputDTO => inputDTO.SizeWidthUnit).Matches(@"^[a-zA-Z0-9À-ỹ\s]+$").When(inputDTO => inputDTO.IsNew).WithMessage("Size width unit can not contains special character");
            ...
            RuleFor(inputDTO => inputDTO.ColorName).Matches(@"^[a-zA-Z0-9À-ỹ\s]+$").When(inputDTO => inputDTO.IsNew).WithMessage("Color name can not contains special character");
