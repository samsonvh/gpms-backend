...
{
    public class ProcessInputDTOValidator : AbstractValidator<ProcessInputDTO>
    {
        public ProcessInputDTOValidator()
        {
            ...
            RuleFor(inputDTO => inputDTO.Steps.Count).GreaterThan(0).WithMessage("Step list is required");
        }
    }
}