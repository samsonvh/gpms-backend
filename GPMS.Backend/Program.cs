...
builder.Services.AddCors(options =>
{
    ...
    {
        builder.WithOrigins("http://dev-our.com","http://localhost:5173", "http://localhost:5174", "http://localhost:3000", "https://gpms-frontend-samsonvhs-projects.vercel.app/", "https://rpms-web.vercel.app/","http://localhost:4200")
               .AllowAnyHeader()
               .AllowAnyMethod();
    });
});
